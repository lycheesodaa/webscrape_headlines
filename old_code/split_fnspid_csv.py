...
# Processing technical analysis information of top 50 stocks with pandas ta
top50_news_dir = directory + 'top50_news/'
top50_proc_dir = directory + 'top50_processed/'
top50_csv_list = os.listdir(top50_news_dir)
#
# for i, stock in enumerate(top50_csv_list):
#     print(f'Processing {stock} ({i})...')
#     try:
#         shutil.copyfile(hist_directory + stock, top50_proc_dir + f'/{stock}')
#     except FileNotFoundError as e:
#         print(e)
#         shutil.copyfile(hist_directory + stock.lower(), top50_proc_dir + f'/{stock}')
#
...
for i, csv_file in enumerate(file_list):
    if csv_file.endswith('.csv'):
        ...
        tech_df = pd.read_csv(top50_proc_dir + csv_file)
        ...
        tech_df.to_csv(top50_proc_dir + csv_file, index=False)
