...
result_folder = Path("/home/lianlian/webscrape_headlines/results/compare_models_daily/ARIMA_rolling")
instance_norm = True
if instance_norm:
...
horizons = [7, 365]  # Predict X days ahead
...
def find_optimal_params(win_size):
    windows = []
    for idx in range(win_size, len(price_data), win_size):
        windows.append(price_data[idx - win_size:idx])
