...
result_folder = Path("/home/lianlian/webscrape_headlines/results/compare_models_monthly_0feat/GARCH_rolling/")
instance_norm = True
if instance_norm:
...
horizons = [6, 18]  # Predict X steps ahead
...
for horizon in horizons:
    ...
    for window_size in window_sizes:
        ...
        for i in range(test_start_idx - 1, len(price_data) - horizon + 1):
            # Extract window
            ...
            try:
                ...
                print(f"Error at index {i}: {str(e.with_traceback())}")
                continue
