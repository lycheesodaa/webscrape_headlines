...
result_folder = "C:/Users/jiangl2/PycharmProjects/carbonpriceforecast/data/InfluencingFactors/results/compare_models_monthly/XGboost"
TopFeaturePerc = 0.2 # Select top 40% of the full set of features
# Create Features and Multi-Step Targets
forecast_horizon = 3  # Steps ahead to forecast
lookback = 8  # Number of past months used for prediction
...
# Save Plot
plot_file = os.path.join(result_folder, "xgb_MultiStep.png")
...
results_file = os.path.join(result_folder, "xgb_MultiStep.xlsx")
