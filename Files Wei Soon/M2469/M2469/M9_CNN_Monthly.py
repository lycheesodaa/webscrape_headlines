...
result_folder = "C:/Users/jiangl2/PycharmProjects/carbonpriceforecast/data/InfluencingFactors/results/compare_models_monthly/CNN"
...
# Save Plot
plot_file = os.path.join(result_folder, "CNN_MultiStep.png")
...
results_file = os.path.join(result_folder, "CNN_MultiStep.xlsx")
